...
import CreateMaterialDialog from "./CreateMaterialBatchDialog";
import UpdateMaterialDialog from "./UpdateMaterialBatchDialog";

export default function MaterialBatchDetail() {
  ...
  const fetchMaterial = async () => {
    ...
    try {
      ...
      if (!data || !data.data) {
        toast.error("Không có dữ liệu lô nguyên liệu");
        return;
      }
      setItems(data);
    } catch (error) {
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <div className="bg-[#2a2a2a] p-6 rounded-xl shadow-xl w-80 space-y-4">
            ...
            <p className="text-[#ababab] text-sm">
              Bạn có chắc muốn xoá lô nguyên liệu:{" "}
